...
function mapFromDittoProtocolMsg(namespace, id, group, channel, criterion, action, path, dittoHeaders, value, status, extra) {
    let textPayload = '{\"thingId\": \"' + namespace + ':' + id + '\", \"temperature\": ' + value.temperature.properties.value + ', \"humidity\": ' + value.humidity.properties.value + ', \"mq\": ' + value.mq.properties.value + '}'; 
