...
function mapFromDittoProtocolMsg(namespace, id, group, channel, criterion, action, path, dittoHeaders, value, status, extra) {
    let textPayload = '{\"thingId\": \"' + namespace + ':' + id + '\", \"temperature\": ' + value.temperature.properties.value + ', \"waterQuantity\": ' + value.waterQuantity.properties.value + ', \"waterFatContent\": ' + value.waterFatContent.properties.value + '}'; 
